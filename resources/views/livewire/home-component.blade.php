<main id="main">
    <div class="container">
                ...
                @forelse ($sliders as $slider)
                    ...
                    <div class="item-slide">
                        <img src="{{ asset('assets/images/sliders') }}/{{ $slider->image }}"
                            alt="{{ $slider->title }}" class="img-slide">
        ...
        <!--On Sale-->
        @if ($on_sale_products->count() > 0 && $sale->status == 1 && $sale->sale_date > Carbon\Carbon::now())
        ...
        <div class="wrap-show-advance-info-box style-1 has-countdown">
            ...
            <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container " data-items="5"
                ...
                @forelse ($on_sale_products as $on_sale_product)
                <div class="product product-style-2 equal-elem ">
                    <div class="product-thumnail">
                        <a href="{{ route('product.details', ['slug' => $on_sale_product->slug]) }}" title="{{ $on_sale_product->name }}">
                            <figure><img src="{{ asset('assets/images/products') }}/{{ $on_sale_product->image }}" width="800"
                                    height="800" alt="{{ $on_sale_product->name }}"></figure>
                        </a>
                    ...
                    <div class="product-info">
                        <a href="{{ route('product.details', ['slug' => $on_sale_product->slug]) }}" class="product-name"><span>{{ $on_sale_product->name }}</span></a>
                        <div class="wrap-price"><ins><p class="product-price">{{ $on_sale_product->sale_price }}</p></ins><span class="product-price">{{ $on_sale_product->regular_price }}</span></div>
                    </div>
                </div>
                @empty
