			...
			<div class=" main-content-area">
				...
				<div class="summary">
					...
					<div class="update-clear">
						<a class="btn btn-clear" href="#" wire:click.privent="destroyAll()">Clear Shopping Cart</a>
                ...
                <div class="wrap-iten-in-cart">
                    <h3 class="title-box" style="border-bottom: 1px solid; paddind-bottom:15px;">{{Cart::instance('saveForLater')->count()}} Items Saved For Later</h3>
