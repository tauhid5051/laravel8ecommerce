                    ...
                    <div class="panel-body">
                        ...
                        <form action="" class="form-horizontal" enctype="multipart/form-data"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="" id="" placeholder="Regular Price"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="" id="" placeholder="Sale Price"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="" id="" placeholder="SKU" class="form-control input-md"
                                        wire:model="SKU">
                                    @error('SKU')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4" wire:ignore>
                                    <textarea name="short_description" id="short_description" cols="5" rows="5"
